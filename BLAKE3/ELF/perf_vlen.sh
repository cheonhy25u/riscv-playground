#!/bin/bash
# perf_vlen_b3.sh - x86, AVX2, RISC-V, RISC-V V-Type(VLEN 256, 512, 1024) 성능 비교
...
executables=(
  "./b3_x86"
  "./b3_avx2"
  "spike -m8192 --isa=rv64gcv --disable-dtb --rbb-port=0 --log-commits=0 ./b3_riscv"
)

# ✅ RISC-V V-Type 실행 파일만 VLEN 설정 추가
for vlen in "${vlen_values[@]}"; do
  executables+=("spike --isa=rv64gcv_zve32x_vlen=${vlen} -m8192 --disable-dtb --rbb-port=0 --log-commits=0 ./b3_riscv_v")
done
